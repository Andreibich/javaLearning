...
import domain.AuthorMiddleNameComparator;
import domain.AuthorNameComparator;
import domain.AuthorSurnameComparator;
import domain.Book;
import domain.CatalogComparator;
import domain.Category;
import domain.Student;
import domain.StudentSurnameComparator;
import util.LetterCheck;
