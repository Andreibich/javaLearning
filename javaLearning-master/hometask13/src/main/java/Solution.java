...
//    Task1
    ...
    static void task1Method(String file1, String file2) {
        try (FileReader fileReader = new FileReader("src/com/htp/src.main.java.hometask13/test/" + file1);
             BufferedReader br = new BufferedReader(fileReader);
             FileWriter fileWriter = new FileWriter("src/com/htp/src.main.java.hometask13/test/" + file2);
    ...
    static void task2Method(String file1, String file2) {
        try (FileWriter fileWriter1 = new FileWriter("src/com/htp/src.main.java.hometask13/test/" + file1);
             BufferedWriter bw1 = new BufferedWriter(fileWriter1);
             PrintWriter pw1 = new PrintWriter(bw1);
             FileReader fileReader = new FileReader("src/com/htp/src.main.java.hometask13/test/" + file1);
             BufferedReader br = new BufferedReader(fileReader);
             FileWriter fileWriter2 = new FileWriter("src/com/htp/src.main.java.hometask13/test/" + file2);
