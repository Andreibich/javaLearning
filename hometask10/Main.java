...
//        Task 2
        ...
        System.out.println();
        for (Book element : bookHashSet2) {
            char a = element.getTitle().charAt(0);
            if (a == 'А' | a == 'У' | a == 'Е' | a == 'О' | a == 'Э' | a == 'Я' | a == 'И' | a == 'Ю') {
                System.out.println(element);
            }
        }
        System.out.println();
...
//        Task 3
        ...
        TreeSet<Book> bookTreeSet3 = new TreeSet<>(new AuthorSurnameComparator());
...
//        Task 5
        ...
        Collections.sort(list, new CatalogMinMaxComparator());
        ...
        System.out.println("\nMax Value - " + Collections.max(list, new CatalogMinMaxComparator()) + "\n");
