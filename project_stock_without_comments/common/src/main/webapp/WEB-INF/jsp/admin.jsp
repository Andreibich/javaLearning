...
<ul>
    <li><a href="">Users</a>
        <ul>
            <li><a href="FrontController?command=test_command">View List</a></li>
            <li><a href="FrontController?command=registration">Create new user</a></li>
            <%--<li><a href="/stock/userCreation">Create new user</a></li>--%>
        </ul>
    </li>
    ...
    <%--<li><a href="">Receipt</a>--%>
        <%--<ul>--%>
            <%--<li><a href="#">View all receipts</a></li>--%>
    ...
    <%--<li><a href="">Shipment</a>--%>
        <%--<ul>--%>
            <%--<li><a href="#">View all shipments</a></li>--%>
    ...
    <%--<li><a href="">Stock</a>--%>
        <%--<ul>--%>
            <%--<li><a href="#">View all products in stock by now</a></li>--%>
