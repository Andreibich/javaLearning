...
public class ShipmentView implements CommandInterface {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws CommandException, IOException {
        try {
            request.setAttribute("shipmentList", SERVICE.loadAll());
    ...
    private static class SingletonHolder {
        private static final CommandInterface INSTANCE = new ShipmentView();
    }
}
