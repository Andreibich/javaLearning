...
public class SQLShipmentDAO implements ShipmentDAO {
    ...
    private static final String SELECT_BY_PRODUCT_NAME_AND_PERIOD = "SELECT shipment.shipment_id, shipment.shipment_date, " +
            ...
            "operation_codes.operation_code_id = shipment.operation_code_id WHERE product_catalog.product_name = ? AND " +
...
//            "invoice_number, proxy_number, recepient_employee_name
    ...
    public int create(Shipment entity) throws DaoException {
        try (Connection connect = pool.getConnection();
            ...
            statement.setDate(2, entity.getShipmentDate());
    ...
    private Shipment getEntry(ResultSet set) throws DaoException {
        try {
            ...
            shipment.setShipmentDate(set.getDate(SHIPMENT_DATE));
